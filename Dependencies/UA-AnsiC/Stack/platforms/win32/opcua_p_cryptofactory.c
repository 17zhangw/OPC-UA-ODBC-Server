...
OpcUa_InitializeStatus(OpcUa_Module_P_CryptoFactory, "CreateCryptoProvider");
    ...
    {
        pConfig = (OpcUa_CryptoProviderConfig*)OpcUa_P_Memory_Alloc(sizeof(OpcUa_CryptoProviderConfig));
        OpcUa_GotoErrorIfAllocFailed(pConfig);
                                    ...
                                    OpcUa_P_String_strlen(OpcUa_SecurityPolicy_Basic256Sha256))==0)
    {
        ...
        pConfig->DerivedSignatureKeyLength  = 32;
        pConfig->MaximumAsymmetricKeyLength = 512;
        pConfig->MinimumAsymmetricKeyLength = 256;
